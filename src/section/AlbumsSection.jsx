...
const AlbumsSection = ({ id, isLoggedIn }) => {
  ...
  var thumbnails = [
    {
      url: "https://firebasestorage.googleapis.com/v0/b/blogging-97ff7.appspot.com/o/thumbnails%2FAnime_and_Cosplay_Expo_2022_thumbnail.jpg?alt=media&token=ccfc766b-6b31-4976-a532-50659153ab84",
    ...
    {
      url: "https://firebasestorage.googleapis.com/v0/b/blogging-97ff7.appspot.com/o/thumbnails%2FDoctor_Strange_and_the_Multiverse_of_Madness_Premiere_thumbnail.jpg?alt=media&token=4f71078c-b6a9-4685-bb69-d176b5ba9703",
      orientation: "portrait",
    },
  ];
        ...
        <div className={"album-grid" + (id ? " album-photo" : "")}>
          {Array.from(Array(isDashboard ? 3 : 55)).map((card, i) => {
            ...
            return (
              ...
              >
                <div
                  className={index + " thumbnail " + orientation}
                  style={{
